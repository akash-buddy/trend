...
with tab2:
    ...
    if st.button("Get Chain"):
        ...
        Final_chain2=Final_chain1.rename(columns={"CE_OI":"Open Interest","CE_CHNG_IN_OI":"CHNG Open Interest","CE_VOLUME":"Volume","CE_LTP":"Last Traded Price","PE_LTP":"Last Traded Price"})
